...
namespace QuickMediaSorter.ObjectModel
{
    ...
    {
        [XmlIgnore]
        public Dictionary<Keys, QuickMediaSorterProjectTriggerAction> ActionsDict { get; set; }
        ...
        public void InitializeActions()
        {
            ...
            ActionsDict = new Dictionary<Keys, QuickMediaSorterProjectTriggerAction>();

            // Create default actions
            ActionsDict[Keys.Delete] = new QuickMediaSorterProjectTriggerAction(ActionType.Delete);
            ActionsDict[Keys.Left] = new QuickMediaSorterProjectTriggerAction(ActionType.Previous);
            ActionsDict[Keys.Right] = new QuickMediaSorterProjectTriggerAction(ActionType.Next);

            // Merge the existing actions
            foreach (QuickMediaSorterProjectTrigger trigger in Trigger)
            {
                ActionsDict[trigger.KeyCode] = trigger.Action;
            }
        ...
        internal static QuickMediaSorterProject GetDefault()
        {
            ...
            trigger.Key = Keys.ControlKey.ToString();
